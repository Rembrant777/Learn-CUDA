                          ...
                          const int size, const int bufsize)
{
    ...
    // copy host -> device
    CHECK_CUDA_ERROR(cudaMemcpyAsync(d_a, h_a, bufsize, cudaMemcpyHostToDevice, _stream));
    CHECK_CUDA_ERROR(cudaMemcpyAsync(d_b, h_b, bufsize, cudaMemcpyHostToDevice, _stream));
    ...
    // copy device -> host
    CHECK_CUDA_ERROR(cudaMemcpyAsync(h_c, d_c, bufsize, cudaMemcpyDeviceToHost, _stream));
