...
TEST(TestCudnnActivationDescriptor, CreateReluActivationDescriptor) 
{
    ...
    double coef                     = 0.0; 
    EXPECT_EQ(mode, CUDNN_ACTIVATION_RELU);
...
TEST(TestCudnnActivationDescriptor, ApplyReluActivationForward)
{
    EXPECT_EQ(1, 1);
}


TEST(TestCudnnActivationDescriptor, ApplyReluActivationBackforward)
{
    EXPECT_EQ(1, 1);
}