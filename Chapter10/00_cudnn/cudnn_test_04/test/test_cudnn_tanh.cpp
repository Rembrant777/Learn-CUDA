...
TEST(TestCudnnActivationDescriptor, CreateTanhActivationDescriptor)
{
    ...
    double coef                     = 0.0; 
    EXPECT_EQ(mode, CUDNN_ACTIVATION_TANH);
...
TEST(TestCudnnActivationDescriptor, ApplyTanhActivationForward)
{
    EXPECT_EQ(1, 1);
}


TEST(TestCudnnActivationDescriptor, ApplyTanhActivationBackforward)
{
    EXPECT_EQ(1, 1);
}